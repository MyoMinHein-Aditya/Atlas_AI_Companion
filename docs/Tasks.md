...
## Phase 6: System Metrics & Active Context Monitoring (Completed)

- [x] Integrated `psutil` library into `backend/requirements.txt`
- [x] Developed `SystemService` in `backend/app/services/system.py` (CPU, RAM, Disk, Windows ctypes active window tracking)
- [x] Added GET `/api/system/context` endpoint and WebSocket AI prompt context injection
- [x] Added `tests/test_system.py` unit test suite (13/13 tests passing)
